...
<section class="section" id="faecher">
  ...
  <div class="card-grid">
    <article class="card"><h3>Mathematik</h3><p>Von Grundrechenarten bis Analysis, Algebra und Abitur.</p><a href="/nh_seo/mathe-nachhilfe-leipzig.php">Mathe-Nachhilfe Leipzig →</a></article>
    <article class="card"><h3>Physik</h3><p>Mechanik, Elektrizitätslehre, Optik und moderne Physik.</p><a href="/nh_seo/physik-nachhilfe-leipzig.php">Physik-Nachhilfe Leipzig →</a></article>
    <article class="card"><h3>Chemie</h3><p>Stoffe, Reaktionen, Gleichgewichte und organische Chemie.</p><a href="/nh_seo/chemie-nachhilfe-leipzig.php">Chemie-Nachhilfe Leipzig →</a></article>
    <article class="card"><h3>Informatik</h3><p>Algorithmen, Programmierung, Datenbanken und Netzwerke.</p><a href="/nh_seo/informatik-nachhilfe-leipzig.php">Informatik-Nachhilfe Leipzig →</a></article>
    <article class="card"><h3>Deutsch</h3><p>Grammatik, Textverständnis, Schreiben und Prüfung.</p><a href="/nh_seo/deutsch-nachhilfe-leipzig.php">Deutsch-Nachhilfe Leipzig →</a></article>
    <article class="card"><h3>Englisch</h3><p>Grammar, vocabulary, writing, speaking und Prüfung.</p><a href="/nh_seo/englisch-nachhilfe-leipzig.php">Englisch-Nachhilfe Leipzig →</a></article>
    <article class="card"><h3>Weitere Sprachen</h3><p>Französisch, Spanisch und Latein mit strukturierter Methodik.</p><a href="/nh_seo/faecher.php">Alle Sprachfächer →</a></article>
    <article class="card"><h3>Alle Fächer</h3><p>Die vollständige Übersicht mit neun Fachangeboten.</p><a href="/nh_seo/faecher.php">Fächerübersicht →</a></article>
  </div>
</section>
