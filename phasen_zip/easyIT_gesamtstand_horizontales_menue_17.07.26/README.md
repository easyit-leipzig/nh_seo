...
## Navigation – Stand 17.07.2026

Die frühere vertikale Seitennavigation wurde durch ein horizontales, responsives Hauptmenü ersetzt:

- Start
- Über (Über mich, Warum easyIT?, Methodik & Unterrichtsregeln, Bewertungen)
- Fächer (Übersicht und alle einzelnen Fachseiten)
- Schulformen (Übersicht, Grundschule, Oberschule, Gymnasium, Berufsschule, Abitur, Studium)
- Sonstiges (Preise, Stadtteile, Lernwerkzeuge, Blog, FAQ, Jobs, Kontakt)

Auf kleinen Bildschirmen wird das Menü über den Hamburger-Button als seitliches mobiles Menü geöffnet. Untermenüs werden dort per Schaltfläche auf- und zugeklappt.
