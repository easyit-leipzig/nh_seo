...
<nav class="breadcrumbs" aria-label="Brotkrumen"><a href="/">Startseite</a><span>›</span><span aria-current="page">Häufige Fragen zur Nachhilfe</span></nav>
...
<section class="section cta"><div><h2>Eine Frage ist noch offen?</h2><p>Schreibe kurz, worum es geht. Du erhältst eine konkrete Rückmeldung.</p></div><a class="button button--gold" href="/kontakt.php">Frage stellen</a></section>
