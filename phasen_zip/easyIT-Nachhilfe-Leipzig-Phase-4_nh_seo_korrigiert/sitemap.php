...
<nav class="breadcrumbs" aria-label="Brotkrumen"><a href="/nh_seo/">Startseite</a><span>›</span><span aria-current="page">Sitemap</span></nav>
<section class="section"><span class="eyebrow">Seitenübersicht</span><h1>Sitemap</h1>
<div class="card-grid card-grid--3">
<article class="card"><h2>Fächer</h2><ul><?php foreach($subjects as $subject): ?><li><a href="/nh_seo/<?= e($subject['file']) ?>"><?= e($subject['name']) ?></a></li><?php endforeach; ?></ul></article>
<article class="card"><h2>Leipzig & Stadtteile</h2><ul><?php foreach($areas as $area): ?><li><a href="/nh_seo/<?= e($area['file']) ?>"><?= e($area['name']) ?></a></li><?php endforeach; ?></ul></article>
<article class="card"><h2>Schulformen</h2><ul><?php foreach($schoolTypes as $type): ?><li><a href="/nh_seo/<?= e($type['file']) ?>"><?= e($type['name']) ?></a></li><?php endforeach; ?></ul></article>
</div>
