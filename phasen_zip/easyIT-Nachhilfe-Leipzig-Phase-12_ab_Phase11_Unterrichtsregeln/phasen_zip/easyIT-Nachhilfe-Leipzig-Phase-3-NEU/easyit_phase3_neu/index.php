...
<section class="section" id="faecher">
  ...
  <div class="card-grid">
    ...
    <article class="card"><h3>Deutsch</h3><p>Grammatik, Textverständnis, Schreiben und Prüfung.</p><a href="/deutsch-nachhilfe-leipzig.php">Deutsch-Nachhilfe Leipzig →</a></article>
    <article class="card"><h3>Englisch</h3><p>Grammar, vocabulary, writing, speaking und Prüfung.</p><a href="/englisch-nachhilfe-leipzig.php">Englisch-Nachhilfe Leipzig →</a></article>
    <article class="card"><h3>Weitere Sprachen</h3><p>Französisch, Spanisch und Latein mit strukturierter Methodik.</p><a href="/faecher.php">Alle Sprachfächer →</a></article>
    <article class="card"><h3>Alle Fächer</h3><p>Die vollständige Übersicht mit neun Fachangeboten.</p><a href="/faecher.php">Fächerübersicht →</a></article>
  </div>
</section>
