...
$pageCanonical = $site['base_url'] . '/nh_seo/schulformen.php';
...
<nav class="breadcrumbs" aria-label="Brotkrumen"><a href="/">Startseite</a><span>›</span><span aria-current="page">Schulformen</span></nav>
