...
$pageSchemas = [
    ...
    [
        ...
        'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 2, 'name' => 'Fächer', 'item' => $site['base_url'] . '/nh_seo/faecher.php'],
...
<nav class="breadcrumbs" aria-label="Brotkrumen">
    ...
    <a href="/nh_seo/faecher.php">Fächer</a><span>›</span>
...
<section class="hero subject-hero">
  <div>
    ...
    <div class="hero-actions">
      <a class="button button--gold" href="/nh_seo/kontakt.php?fach=<?= rawurlencode($subject['name']) ?>">Probestunde anfragen</a>
  ...
  <aside class="hero-panel subject-symbol subject-symbol--visual" aria-label="Fachübersicht">
    <img class="subject-hero-image" src="/nh_seo/assets/img/subjects/<?= e($subjectKey) ?>.svg" width="800" height="560" alt="<?= e($subject['name']) ?> anschaulich lernen" loading="eager">
...
<section class="section split-section">
  <div>
    ...
    <p><?= e($subject['exam']) ?></p>
    <a class="text-link" href="/nh_seo/preise.php">Ablauf und Rahmen kennenlernen →</a>
  </div>
...
<section class="section faq" id="faq">
  <header class="section-heading">
    ...
    <a class="text-link" href="/nh_seo/faq.php">Alle Fragen ansehen →</a>
  </header>
...
<section class="section cta">
  ...
  <a class="button button--gold" href="/nh_seo/kontakt.php?fach=<?= rawurlencode($subject['name']) ?>">Unverbindlich anfragen</a>
</section>
</div>
