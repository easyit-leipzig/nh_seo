...
<nav class="breadcrumbs" aria-label="Brotkrumen"><a href="/nh_seo/">Startseite</a><span>›</span><span aria-current="page">Lernwerkzeuge</span></nav>
...
<?php foreach($tools as $tool): ?><a class="tool-card" href="/nh_seo/<?= e($tool['file']) ?>"><span class="tool-card__icon" aria-hidden="true"><?= e($tool['icon']) ?></span><strong><?= e($tool['name']) ?></strong><span><?= e($tool['summary']) ?></span></a><?php endforeach; ?>
</div></section>
